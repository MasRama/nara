...
class StorageService {
  ...
  async delete(relativePath: string): Promise<boolean> {
    ...
    try {
      ...
      console.log(`[Storage] File deleted: ${relativePath}`);
      return true;
    } catch (error) {
  ...
  async deleteDirectory(directory: string): Promise<boolean> {
    ...
    try {
      ...
      console.log(`[Storage] Directory deleted: ${directory}`);
      return true;
    } catch (error) {
      console.error(`[Storage] Failed to delete directory: ${directory}`, error);
      return false;
    }
  }
