 ...
 * 
 * @example
 * // With filters applied before pagination
 ...
 * }
 * const result = await paginate<User>(query.orderBy('created_at', 'desc'), { page, limit });
 * 
 * @example
 * // Use with Inertia response
 * const result = await paginate<User>(query, { page });
