...
<Dialog.Root open={show} onOpenChange={handleOpenChange}>
  <Dialog.Portal>
    ...
    <Dialog.Content class="bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] rounded-xl border border-border shadow-lg sm:max-w-lg font-body overflow-hidden outline-none">
